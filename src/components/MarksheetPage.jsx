...
export default function MarksheetPage({ student, subjects, examType, session, signDate, photoSrc }) {
  ...
  const subjectData = subjects.map((s) => {
    ...
    return { name: s.name, full: m.full, written: m.written, oral: m.oral, total, grade }
  })
    ...
    <section className="sheet p-4 flex flex-col">
      <div className="main-content border-2 border-black h-full flex flex-col">
        ...
        <div className="flex justify-between px-2">
          ...
          <div className="flex-grow font-semibold text-center">AN ISO 9001:2015 CERTIFIED SCHOOL</div>
          <div className="font-semibold">Reg. No. 054631</div>
        </div>

        {/* ── School header ────────────────────── */}
        <div className="flex justify-between px-2 py-2">
          <div><img width="84" src="/assets/ama300.webp" alt="logo" /></div>
          <div className="flex-grow flex flex-col text-center">
            ...
            <div className="text-sm">
              Run &amp; Managed by AnitaBindeshwar Foundation (Regd. under Company Act 2013)
            </div>
          </div>
          <div><img width="84" src="/assets/bbbp300.webp" alt="Beti Bachao Beti Padhao" /></div>
        </div>
        ...
        <div className="w-full border-t-2 border-black py-2 px-4">
          <div className="flex gap-x-2">
              ...
              <table className="w-full text-left">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-3 py-2">:</td>
                    <td className="px-3 py-2" colSpan={4}>{student.address}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            {/* Student photo */}
            <div>
              <div className="border-2 border-black w-[150px] h-[180px] overflow-hidden bg-white flex items-center justify-center">
                {photoSrc
                  ? <img src={photoSrc} className="w-full h-full object-cover" alt="Student" />
                  : <span className="text-gray-400 text-xs text-center leading-relaxed">Paste<br />Photo<br />Here</span>
                }
              </div>
            </div>
          </div>
        ...
        <div className="px-4 py-2">
          <table className="border border-black w-full text-center">
            <tbody>
              ...
              <tr>
                <td className="border border-black px-2 py-1">{totalObtained} / {totalFull}</td>
        ...
        {/* ── Green footer bar ─────────────────── */}
        <div className="bg-green-700 text-white px-1 py-[1px] flex justify-between border-t-2 border-black">
          {/* Phone */}
          <div className="flex">
            <svg className="size-5 text-white m-auto mr-1" xmlns="http://www.w3.org/2000/svg"
              width="24" height="24" fill="none" viewBox="0 0 24 24">
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                d="M18.427 14.768 17.2 13.542a1.733 1.733 0 0 0-2.45 0l-.613.613a1.732 1.732 0 0 1-2.45 0l-1.838-1.84a1.735 1.735 0 0 1 0-2.452l.612-.613a1.735 1.735 0 0 0 0-2.452L9.237 5.572a1.6 1.6 0 0 0-2.45 0c-3.223 3.2-1.702 6.896 1.519 10.117 3.22 3.221 6.914 4.745 10.12 1.535a1.601 1.601 0 0 0 0-2.456Z" />
            </svg>
            <a className="my-auto" href="tel:+919128289100">9128289100</a>
          </div>
          {/* WhatsApp */}
          <div className="flex">
            <svg className="size-5 text-white my-auto mr-1" xmlns="http://www.w3.org/2000/svg"
              width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/919973757920?text=Hi%20I%20need%20help" className="my-auto">9973757920</a>
          </div>
          {/* Email */}
          <div className="flex">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
              stroke="currentColor" className="size-5 my-auto mr-1">
              <path strokeLinecap="round" strokeLinejoin="round"
                d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
            </svg>
            <a href="mailto:anshumemorial@gmail.com" className="my-auto">anshumemorial@gmail.com</a>
          </div>
          {/* Website */}
          <div className="flex">
            ...
            <a href="https://anshumemorial.in" className="my-auto">anshumemorial.in</a>
          </div>
        </div>
